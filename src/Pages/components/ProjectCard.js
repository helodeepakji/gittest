    ...
    <div class="project-card-new0">
      <div class="project-card-new">
        <div class="message-container-new">
          ...
          <textarea class="message-text-new cardin" style={{ width: '100%' }} value={message}
            onChange={(e) => setMessage(e.target.value)}></textarea>
        </div>
        <hr />
        <div class="engagement-new">
          <div className="like-new">
            <input type="file" id="inputImage" accept="image/*" name="images[]" style={{ display: 'none' }} multiple onChange={handleFileChange} />
